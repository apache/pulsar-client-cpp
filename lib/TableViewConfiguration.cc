...
long TableViewConfiguration::getAutoUpdatePartitionSeconds() const {
    return impl_->autoUpdatePartitionSeconds_;
}

TableViewConfiguration& TableViewConfiguration::setAutoUpdatePartitionSeconds(
    long autoUpdatePartitionsSeconds) {
    impl_->autoUpdatePartitionSeconds_ = autoUpdatePartitionsSeconds;
    return *this;
}
