...
class PULSAR_PUBLIC TableViewConfiguration {
   public:
    ...
    /**
     * @return autoUpdatePartitionsSeconds
     */
    long getAutoUpdatePartitionSeconds() const;

    /**
     * Set the interval of updating partitions.
     *
     * @param autoUpdatePartitionsSeconds unit: seconds
     */
    TableViewConfiguration& setAutoUpdatePartitionSeconds(long autoUpdatePartitionsSeconds);
